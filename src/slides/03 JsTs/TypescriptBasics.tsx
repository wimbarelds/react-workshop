...
export function TypescriptBasics() {
  return (
    <Prose>
      ...
      <ul>
        <li><strong>TypeScript</strong> is een superset van JavaScript met extra mogelijkheden, zoals types.</li>
      ...
      <h2>🧰 Interfaces</h2>
      <ul>
        <li><strong>Interfaces</strong> definiëren hoe een object moet worden gestructureerd.</li>
      ...
      <ol>
        <li><strong>Definieer types voor je componenten</strong>: Gebruik interfaces om props en state te typeren.</li>
        <li><strong>Consistency</strong>: Zorg ervoor dat je gegevens consistent en voorspelbaar zijn.</li>
        <li><strong>Type Veiligheid</strong>: Voorkom runtime fouten door vooraf typefouten te ontdekken.</li>
      </ol>
